...
export default function Quiz() {
  ...
  const getOptionTextStyle = (option: string) => {
    ...
    const currentQuestion = questions[currentQuestionIndex];
    if (option === currentQuestion.correctWord) return [styles.optionText, styles.optionTextCorrect];
    ...
    return (
      <View style={styles.centerContainer}>
        ...
        <Text style={styles.notEnoughText}>
          Necesitas al menos 4 palabras para jugar al Quiz.
        </Text>
      ...
      <View style={styles.resultContainer}>
        <View style={styles.resultCard}>
          ...
          <View style={styles.resultProgressBar}>
            <View style={[styles.resultProgressFill, { width: `${percentage}%` as any, backgroundColor: isGood ? '#4caf50' : colors.primary }]} />
          </View>
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.questionCard}>
        <Text style={styles.questionLabel}>¿Cómo se dice en inglés?</Text>
      ...
      <View style={styles.optionsContainer}>
        {currentQuestion.options.map((option, index) => (
          ...
          >
            ...
            {selectedOption !== null && option === currentQuestion.correctWord && (
              <FontAwesome name="check" size={18} color="#4caf50" style={styles.optionIcon} />
            )}
            {selectedOption === option && option !== currentQuestion.correctWord && (
